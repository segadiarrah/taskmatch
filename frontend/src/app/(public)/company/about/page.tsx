...
const COPY: Record<"en" | "fr" | "es" | "zh", Copy> = {
  ...
  fr: {
    ...
    cards: [
      ...
      { title: "Ce que nous croyons", body: "Les systèmes d’IA gagnent en utilité quand leur logique est plus claire, plus facile à inspecter et digne de confiance." },
  ...
  es: {
    ...
    cards: [
      ...
      { title: "En qué creemos", body: "Los sistemas de IA son más útiles cuando su lógica es más clara, más inspeccionable y digna de confianza." },
