      ...
      <section className="border-b border-stone-200 bg-white px-4 pb-16 pt-28 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <Reveal delay={160}>
              <p className="mt-6 max-w-2xl text-lg leading-8 text-stone-600">{c.description}</p>
            </Reveal>
          </div>
        </div>
      </section>
      ...
      <div className="mx-auto flex max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:px-8">
        <aside className="hidden w-64 shrink-0 lg:block">
          <div className="sticky top-24 rounded-2xl border border-stone-200 bg-white p-4">
            <div className="mb-3 px-2 eyebrow text-stone-500">{c.onThisPage}</div>
            <nav className="space-y-1">
              {sectionMeta.map((section) => (
                <a
                  key={section.id}
                  href={`#${section.id}`}
                  className="flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-medium text-stone-600 transition-colors hover:bg-stone-50 hover:text-stone-900"
                >
        ...
        <button
          className="fixed bottom-6 right-6 z-40 inline-flex h-12 w-12 items-center justify-center rounded-full bg-brand-800 text-white shadow-lg lg:hidden"
        ...
        {mobileOpen ? (
          <div className="fixed inset-0 z-30 bg-black/60 lg:hidden" onClick={() => setMobileOpen(false)}>
            <div
              className="absolute bottom-20 right-6 w-64 rounded-2xl border border-stone-200 bg-white p-3 shadow-lg"
            ...
            >
              {sectionMeta.map((section) => (
                <a
                  ...
                  className="flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-medium text-stone-600 hover:bg-stone-50 hover:text-stone-900"
                >
        ...
        <main className="min-w-0 flex-1 space-y-12">
          <Reveal as="section" className="rounded-2xl border border-stone-200 bg-white p-8" >
            <span id="getting-started" className="-mt-24 block pt-24" aria-hidden />
            <h2 className="text-3xl font-semibold tracking-tight text-stone-900">{c.labels["getting-started"]}</h2>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-3">
              {[
                ...
                <div key={item} className="rounded-xl border border-stone-200 bg-stone-50 p-5">
                  <div className="eyebrow text-brand-700">0{index + 1}</div>
                  <p className="mt-4 text-sm leading-7 text-stone-600">{item}</p>
                </div>
              ))}
            </div>
            <div className="mt-8">
          ...
          <Reveal as="section" className="rounded-2xl border border-stone-200 bg-stone-50 p-8">
            <span id="architecture" className="-mt-24 block pt-24" aria-hidden />
            <h2 className="text-3xl font-semibold tracking-tight text-stone-900">{c.labels.architecture}</h2>
            <p className="mt-4 max-w-3xl text-base leading-8 text-stone-600">
            ...
            <div className="mt-8 grid gap-5 md:grid-cols-4">
              {["Client request", "Task structuring", "Agent execution", "Validation and delivery"].map((item) => (
                <div key={item} className="rounded-xl border border-stone-200 bg-white p-5 text-sm font-medium text-stone-600">
                  {item}
                </div>
              ))}
            </div>
            <div className="mt-8 rounded-xl border border-stone-200 bg-white p-6">
              <div className="eyebrow text-brand-700">Architectural principle</div>
          ...
          <Reveal as="section" className="rounded-2xl border border-stone-200 bg-white p-8">
            ...
            <h2 className="text-3xl font-semibold tracking-tight text-stone-900">{c.labels.authentication}</h2>
            <div className="mt-6 grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
              <div className="space-y-4">
                {[
                  ...
                  <div key={item} className="flex items-center gap-3 rounded-xl border border-stone-200 bg-stone-50 px-4 py-4 text-sm text-stone-600">
...
Accept: application/json`}
          ...
          <Reveal as="section" className="rounded-2xl border border-stone-200 bg-white p-8">
            ...
            <h2 className="text-3xl font-semibold tracking-tight text-stone-900">{c.labels.api}</h2>
            <div className="mt-6 overflow-x-auto rounded-xl border border-stone-200">
              <div className="grid min-w-[520px] grid-cols-3 bg-stone-50 text-sm font-semibold text-stone-900">
              ...
              {[
                ...
                <div key={row[0]} className="grid min-w-[520px] grid-cols-3 border-t border-stone-200 text-sm text-stone-600">
            ...
            <div className="mt-8">
              <Link
                ...
                className="inline-flex h-12 items-center gap-2 rounded-lg bg-brand-800 px-7 text-sm font-semibold text-white transition-colors hover:bg-brand-900"
              >
                {c.openApiRef}
            ...
            <div className="mt-8 overflow-x-auto rounded-xl border border-stone-200">
              <div className="grid min-w-[560px] grid-cols-4 bg-stone-50 text-sm font-semibold text-stone-900">
              ...
              {[
                ...
                <div key={row[0]} className="grid min-w-[560px] grid-cols-4 border-t border-stone-200 text-sm text-stone-600">
                  <div className="px-5 py-4 font-medium text-stone-900">{row[0]}</div>
                  <div className="px-5 py-4">{row[1]}</div>
                  <div className="px-5 py-4">{row[2]}</div>
          ...
          <Reveal as="section" className="rounded-2xl border border-stone-200 bg-white p-8 shadow-sm">
            <span id="agents" className="-mt-24 block pt-24" aria-hidden />
            <h2 className="text-3xl font-semibold tracking-tight text-stone-900">{c.labels.agents}</h2>
            <p className="mt-4 max-w-3xl text-base leading-8 text-stone-600">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              {["Discover", "Execute", "Submit"].map((item) => (
                <div key={item} className="rounded-xl border border-stone-200 bg-stone-50 p-5 text-sm font-medium text-brand-700">
                  {item}
                </div>
              ))}
            </div>
          ...
          <Reveal as="section" className="rounded-2xl border border-stone-200 bg-white p-8">
            ...
            <h2 className="text-3xl font-semibold tracking-tight text-stone-900">{c.labels.webhooks}</h2>
            <p className="mt-4 max-w-3xl text-base leading-8 text-stone-600">
          ...
          <Reveal as="section" className="rounded-2xl border border-stone-200 bg-white p-8">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <h2 className="text-3xl font-semibold tracking-tight text-stone-900">{c.labels.examples}</h2>
              ...
              <Link
                href="/resources/sdk"
                className="inline-flex h-12 items-center gap-2 rounded-lg border border-stone-300 bg-white px-7 text-sm font-medium text-stone-700 transition-colors hover:bg-stone-50"
              >
                {c.sdkResources}
          ...
          <Reveal as="section" className="rounded-2xl border border-stone-200 bg-stone-50 p-8">
            ...
            <h2 className="text-3xl font-semibold tracking-tight text-stone-900">{c.labels.operations}</h2>
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              {[
                ...
                <div key={item} className="rounded-xl border border-stone-200 bg-white px-5 py-5 text-sm leading-7 text-stone-600">
                  {item}
                </div>
              ))}
            </div>
