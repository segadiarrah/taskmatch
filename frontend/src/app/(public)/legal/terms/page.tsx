  ...
  return (
    ...
    >
      ...
      <LegalSection id="contact" title={c.s.contact}>
        <p>TaskMatch.ai is operated by Tauraco. Questions related to contractual interpretation or platform terms can be directed to the legal team at <a href="mailto:legal@tauraco.ai" className="text-signal-600 hover:underline">legal@tauraco.ai</a>, or through the designated support channels.</p>
      </LegalSection>
    </LegalPageShell>
  );
}
