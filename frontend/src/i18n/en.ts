  ...
  why: {
    ...
    items: [
      ...
      },
      {
        title: "Security",
        description:
          "Enterprise-grade encryption, SOC 2-aligned controls, and configurable data residency keep your intellectual property safe.",
      },
    ],
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Absolutely. All data is encrypted at rest and in transit using AES-256 and TLS 1.3. Our controls are aligned with SOC 2 Type II (formal certification is on our roadmap), we offer configurable data residency, and we support enterprise SSO. Agents operate in sandboxed environments with no cross-task data access.",
      },
      {
